  ...
  if (error) {
    return (
      <div className="flex flex-col h-[60vh] items-center justify-center text-center px-4">
        ...
        <p className="text-sm text-text-light mt-4">Make sure to start the Django server: <code>python manage.py runserver</code></p>
      </div>
    );
  }
    ...
    <div className="pb-16 bg-background">
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-lg md:text-xl text-blue-100 mb-8 max-w-lg">
              Shop millions of new, used, and refurbished car spare parts from trusted sellers worldwide.
            </p>
      ...
      {featured.length > 0 && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
          <h2 className="text-2xl font-bold text-text mb-8">Featured Products</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="px-4">
              ...
              <h3 className="text-lg font-semibold text-text mb-2">Verified Sellers</h3>
              <p className="text-text-muted text-sm px-4">Every seller is vetted to ensure you get genuine, quality automotive parts.</p>
            </div>
            <div className="px-4">
              <div className="w-12 h-12 bg-blue-50 text-primary rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" /></svg>
              </div>
              <h3 className="text-lg font-semibold text-text mb-2">Secure Payments</h3>
              <p className="text-text-muted text-sm px-4">Your transactions are encrypted and protected by industry-standard security.</p>
            </div>
            <div className="px-4">
              <div className="w-12 h-12 bg-blue-50 text-primary rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" /></svg>
              </div>
              <h3 className="text-lg font-semibold text-text mb-2">Easy Returns</h3>
              <p className="text-text-muted text-sm px-4">Didn't fit? Return eligible items within 30 days for a hassle-free refund.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {latest.length > 0 && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-20">
          <h2 className="text-2xl font-bold text-text mb-8">Just Added</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {latest.map((prod) => (
              <ProductCard key={prod.id} product={prod} />
            ))}
